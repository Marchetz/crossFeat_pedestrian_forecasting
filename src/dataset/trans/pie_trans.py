...
def get_ped_info_pie(annotations, image_set="all") -> dict:
    ...
    for idx in tqdm.tqdm(pids):
        ...
        frames = dataset[sid][vid]['ped_annotations'][idx]['frames']
        ...
        for i in range(len(frames)):
            spe = dataset[sid][vid]['vehicle_annotations'][frames[i]]['OBD_speed']
            speed_list.append(spe)
        ped_info[idx]['speed'] = speed_list
...
def ped_info_clean_pie(annotations, image_set="all") -> dict:
    ...
    for idx in ids:
        ...
        for i in range(len(full_occ)):
            ...
            ped_info[idx]['speed'][full_occ[i]] = None
        ...
        ped_info[idx]['speed'] = list(filter(filter_None, ped_info[idx]['speed']))
